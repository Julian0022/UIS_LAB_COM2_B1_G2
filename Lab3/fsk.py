...
class fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_multiply_const_vxx_1_0 = blocks.multiply_const_ff(fd)
        ...
        self.connect((self.epy_block_0_1, 0), (self.blocks_multiply_const_vxx_1_0, 0))
    ...
    def set_fd(self, fd):
        self.fd = fd
        self.blocks_multiply_const_vxx_1_0.set_k(self.fd)
