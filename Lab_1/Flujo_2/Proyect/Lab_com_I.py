...
class Lab_com_I(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Lab_com_I")
        ...
        # Blocks
        ##################################################
        self._frequency_range = Range(-samp_rate, samp_rate, 100, 0, 200)
        ...
        self._Amplitud_range = Range(0, 10, 1, 1, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frequency, Amplitud, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, frequency, Amplitud, 0, 0)
    ...
    def set_Amplitud(self, Amplitud):
        ...
        self.analog_sig_source_x_1.set_amplitude(self.Amplitud)




def main(top_block_cls=Lab_com_I, options=None):
